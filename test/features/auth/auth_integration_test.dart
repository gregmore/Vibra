...
class MockMusicProfileRepository extends Mock implements MusicProfileRepository {}
class MockGoRouter extends Mock {}

// Classi fittizie per rappresentare i DataLayer dell'app Vibra
class SpotifyAuthService {
  Future<String> handleOAuthCallback(Uri uri) async { throw UnimplementedError(); }
  Future<Map<String, dynamic>> fetchSpotifyData(String token) async { throw UnimplementedError(); }
}

class MusicProfileRepository {
  Future<void> saveProfile(List<String> artists, List<String> genres) async { throw UnimplementedError(); }
}
...
void main() {
  ...
  group('Spotify OAuth & Sync Integration', () {
    ...
    test('Should catch exceptions and save empty profile without crashing', () async {
      // ARRANGE
