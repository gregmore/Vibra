  ...
  final bots = [
    {
      ...
      'username': 'giuli4',
      'display_name': 'Giulia',
      'bio': 'Adoro i concerti indie e la techno! Cerco compagni per serate a Milano.',
      'avatar_url': 'https://i.pravatar.cc/300?img=5',
      'top_artists': [
        {'id': '1', 'name': 'Calcutta', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5ebc52bc7291a92e1e0a811d017'}]},
        {'id': '2', 'name': 'Fred De Palma', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb4a7c06eb6ab490bb56658098'}]}
      ],
      'top_tracks': [
        {'id': 't1', 'name': 'Oroscopo', 'artists': [{'name': 'Calcutta'}]}
      ],
    ...
    },
    {
      ...
      'top_artists': [
        {'id': '3', 'name': 'Sfera Ebbasta', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb3b1b6eb98f3b0e3532f83db5'}]},
        {'id': '4', 'name': 'Lazza', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb00e6a8e5621453bbcc1f3b23'}]}
      ],
      'top_tracks': [
        {'id': 't2', 'name': 'Cenere', 'artists': [{'name': 'Lazza'}]}
      ],
    ...
    },
    {
      ...
      'top_artists': [
        {'id': '5', 'name': 'Daft Punk', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb3cb0da867d7a46ed258cb253'}]},
        {'id': '6', 'name': 'Peggy Gou', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eba44f7a6f23ad5b50d876527b'}]}
      ],
      'top_tracks': [
        {'id': 't3', 'name': 'One More Time', 'artists': [{'name': 'Daft Punk'}]}
      ],
    ...
    },
    {
      ...
      'display_name': 'Luca',
      'bio': 'Metallaro dal cuore tenero. Cerco qualcuno con cui andare al prossimo concerto dei Metallica. 🎸🤘',
      'avatar_url': 'https://i.pravatar.cc/300?img=68',
      'top_artists': [
        {'id': '7', 'name': 'Metallica', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb8101d13bdd630b0889acd2fd'}]},
        {'id': '8', 'name': 'Slipknot', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb32dbba6cb50cf39570c9a44c'}]}
      ],
      'top_tracks': [
        {'id': 't4', 'name': 'Master of Puppets', 'artists': [{'name': 'Metallica'}]}
      ],
    ...
    },
    {
      ...
      'bio': 'Army forever! ✨ Cerco amici/amiche per ballare e condividere la passione per il K-pop! 💖',
      'avatar_url': 'https://i.pravatar.cc/300?img=47',
      'top_artists': [
        {'id': '9', 'name': 'BTS', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb5704a64f34fe29ff73ab56bb'}]},
        {'id': '10', 'name': 'BLACKPINK', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5ebc7eaeca5aed17cea0f6316ef'}]}
      ],
      'top_tracks': [
        {'id': 't5', 'name': 'Dynamite', 'artists': [{'name': 'BTS'}]}
      ],
    ...
    },
    {
      ...
      'display_name': 'Chiara',
      'bio': 'Reggaeton, bachata e tanto divertimento! 💃🍹 Chi viene a ballare stasera?',
      'avatar_url': 'https://i.pravatar.cc/300?img=32',
      'top_artists': [
        {'id': '13', 'name': 'Bad Bunny', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb957c7b80a2cdbcfbd12797e8'}]},
        {'id': '14', 'name': 'Rosalía', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5ebe8baee9e8306df9a17112001'}]}
      ],
      'top_tracks': [
        {'id': 't7', 'name': 'Me Porto Bonito', 'artists': [{'name': 'Bad Bunny'}]}
      ],
    ...
    },
    {
      ...
      'top_artists': [
        {'id': '15', 'name': 'Gazzelle', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb3e85e2b3471dfc888db73041'}]},
        {'id': '16', 'name': 'Frah Quintale', 'images': [{'url': 'https://i.scdn.co/image/ab6761610000e5eb9e68cd02a8bf804e38e8e788'}]}
      ],
      'top_tracks': [
        {'id': 't8', 'name': 'Destri', 'artists': [{'name': 'Gazzelle'}]}
      ],
  ...
  for (final bot in bots) {
    ...
    try {
      ...
      if (currentUser != null && currentUser.email == bot['email']) {
        ...
        print(' - Errore: Sessione non attiva per ${bot['email']}. Forse l\'account esisteva già o richiede conferma email.');
      }
    } catch (e, st) {
