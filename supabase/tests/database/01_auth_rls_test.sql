...
insert into event_attendees (user_id, event_id, status) values
  ('11111111-1111-1111-1111-111111111111', '12345678-1234-1234-1234-123456789012', 'going');

-- 1. Un utente non autenticato non dovrebbe poter leggere gli eventi salvati
set local role anon;
select is_empty(
  'select * from event_attendees',
  'Anon cannot read event attendees'
);
...
select throws_like(
  $$ insert into event_attendees (user_id, event_id, status) values ('11111111-1111-1111-1111-111111111111', '12345678-1234-1234-1234-123456789012', 'going') $$,
