        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      displayUser.user.displayName ?? displayUser.user.username,
                    ...
                    const SizedBox(height: 6),
                    Text(
                      l10n.userProfileCompatibility(
                        displayUser.compatibility.toString(),
                      ),
          ...
          if (displayUser.topArtists.isNotEmpty) ...[
            ...
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: displayUser.topArtists
          ...
          const SizedBox(height: 18),
          Text(
            '${l10n.userProfileEvents}: ${displayUser.attendingEvents}',
          ...
          Row(
            children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () async {
                      try {
                        await ref
                            .read(requestFriendshipUseCaseProvider)
                            .call(displayUser.user.id);
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(l10n.userProfileFriendRequestSent),
                            ),
                          );
                        }
                      } catch (e) {
              ...
              if (!displayUser.isFriend) const SizedBox(width: 10),
              if (displayUser.isFriend)
                Expanded(
