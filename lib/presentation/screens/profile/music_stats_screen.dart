                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          AppLocalizations.of(
                            context,
                          )!.musicStatsSyncError(e.toString()),
                        ),
                      ),
                    );
                  }
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      ...
                      size: 64,
                      color: VibraColors.textSecondary.withValues(alpha: 0.5),
                    ),
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: VibraColors.surfaceVariant.withValues(
                                  alpha: 0.3,
                                ),
                            ...
                            children: [
                              Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(
                                          color: VibraColors.accent.withValues(
                                            alpha: 0.3,
                                          ),
                                          blurRadius: 6,
                                          spreadRadius: 1,
